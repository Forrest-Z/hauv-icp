...
int align_submaps_ptp(const typename pcl::PointCloud<PointT>::Ptr &source,
  ...
  const typename pcl::registration::TransformationEstimationPointToPlaneLLS<PointTNormal, PointTNormal, float>::Ptr tf_ptp( new pcl::registration::TransformationEstimationPointToPlaneLLS<PointTNormal, PointTNormal, float>);
